# AGENTS.md - smallzh.os 项目指南

## 项目概述

这是一个记录 Linux/Window10+的命令、bash/powershell相关的关键知识的文档项目，使用 MkDocs 构建。项目目标是记录Linux/Window10+的命令、bash/powershell的理解和学习笔记，涵盖从基础到常用的各个方面。
